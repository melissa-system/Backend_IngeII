...
// Política para /auth/reset-password/solicitar y /confirmar: máximo 3
// solicitudes por IP cada 15 minutos. Más estricta que el login porque cada
// solicitud exitosa dispara un correo real (costo de envío) y es un vector
// típico de spam/enumeración de cuentas si no se limita.
...
// Política para /auth/registro: mismo límite conservador que reset. Evita
// registro masivo automatizado de cuentas (spam de correos de bienvenida).
export const INTENTOS_REGISTRO_MAXIMOS = 3;

export const POLITICA_REGISTRO_THROTTLE = {
  default: { limit: INTENTOS_REGISTRO_MAXIMOS, ttl: VENTANA_MS },
} as const;