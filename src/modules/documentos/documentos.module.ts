...
@Module({
  ...
  // Documentos. EmpleadosModule provee EmpleadosService, para saber qué
  // empleado subió cada uno. CloudinaryModule provee el servicio de subida
  // de archivos a la nube.
  imports: [TypeOrmModule.forFeature([Documento]), EmpleadosModule, CloudinaryModule],
